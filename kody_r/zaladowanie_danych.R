...
for (i in 1:length(wibor_file_names)){
  ...
  temp <- temp[-nrow(temp),]
  temp <- rev(temp[,5])
  assign(wibor_var_names[i],temp)
}

used_bonds <- c("3m","6m","9m","12m","24m","36m","48m","60m","108m","120m")
